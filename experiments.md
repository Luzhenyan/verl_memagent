...
|----|------|------|----------|------------|---------|-------------|------------|-----------------|----------------|--------|----------|------------|------|
| exp-006 | thu_a100 | run_sw_docqa_grpo.sh | 2026-04-12 00:44 | 9026dda | DocQA_RL_1.6K (doc len 18k~24k tokens) | 12000 | 1600 | 4 (dataset default) | factor=0.0 (off) | max_resp=37500, rollout_n=4, batch=2 | 从 global_step_100 恢复 | - | 日志: train_sw_docqa_2026-04-12_00-44-19.log；nohup 正确启动 |
