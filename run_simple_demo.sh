...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    critic.model.path=/var/wangyicheng/models/Qwen2.5-0.5B-Instruct/snapshots/7ae557604adf67be50417f59c2c2f167def9a775 \
    critic.ppo_micro_batch_size_per_gpu=1 \
    algorithm.kl_ctrl.kl_coef=0.001 \
    custom_reward_function.path=/home/wangyicheng/verl/verl/utils/reward_score/segmented_reading.py \
