...
class RolloutWorker(Worker):
    def __init__(self, config: RolloutConfig, model_config: HFModelConfig) -> None:
        ...
        if self.config.name == "vllm":
            ...
            print(f"=== DEBUG: Initializing {vllm_rollout_cls.__name__} ===")
            ...
            print(f"=== DEBUG: Initialized {vllm_rollout_cls.__name__} ===")
            print(f"=== DEBUG: Rollout config: {self.config} ===")
            print(f"=== DEBUG: Model path: {self.model_config.local_path} ===")
            print(f"=== DEBUG: worker Rollout mode: {self.config.mode} ===")
            print(f"=== DEBUG: Tensor parallel size: {self.config.tensor_model_parallel_size} ===")
            print(f"=== DEBUG: Device mesh: {rollout_device_mesh} ===")
